            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box">
                    <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="\assets\images\logo.svg" alt="" height="22" style ="
    margin-top: 28px;
">
                                </span>
                        <span class="logo-lg">
                                    <img src="\assets\images\logo_dark_1.png" alt="" height="60" style="margin-top: 15px;">
                                </span>
                    </a>

                    <a href="index.jsp" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="\assets\images\logo-light.svg" alt="" height="22" style="margin-top: 15px;">
                                </span>
                        <span class="logo-lg">
            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn header-item noti-icon waves-effect" id="page-header-notifications-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span class="badge badge-danger badge-pill" style="
    margin-left: -7px;
">3</span>
                    </button>
